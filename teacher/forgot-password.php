...
<head>
    ...
    <title>HTQLHSGV || Quên mật khẩu</title>
...
{
alert("Mật khẩu mới và xác nhận lại mật khẩu mới không khớp  !!");
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                      <h3 style="color:#000">Hệ thống quản lý hồ sơ Giáo viên </h3>
                    <hr  color="red"/>
                </div>
...
<button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="submit">Đặt lại</button>
</form>
