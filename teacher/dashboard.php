...
<head>
    ...
    <title>HTQLHSGV || Bảng điều khiển</title>
...
?>
                        <h3 class="mb-0">
                            <span >Chào mừng quay trở lại :  <?php echo htmlentities($row->Name);?></span>
                        </h3>
                        <hr />
 <?php if($row->isPublic=='1'):?>                       
                        <p class="text-light">Hồ sơ của bạn là công khai(Ai cũng có thể thấy hồ sơ của bạn)</p>
 <?php else: ?>  
 <p class="text-light">Hồ sơ của bạn là riêng tư ( Không ai có thể thấy hồ sơ của bạn)</p>  
 <?php endif;?>                   
<?php } ?>
...
?>
                        ...
                        <p class="text-light">Số truy vấn đã nhận được</p>
