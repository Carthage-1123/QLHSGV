...
<head>
    ...
    <title>HTQLHSGV || Trang điều khiển</title>
                    ...
                    <form action="" method="post" name="login">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="forgot-password.php" style="padding-left: 250px">Quên mật khẩu?</a>
                            </label>

                                </div>
                                <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="login">Sign in</button>
                                <hr />
                                <p style="color:blue">Chưa phải là thành viên ?| <a href="signup.php">Đăng kí ở đây</a></p>
