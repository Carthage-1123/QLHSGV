...
<head>
    ...
    <title>HTQLHSGV || Quản lý giáo viên</title>
...
<?php endif;?>
<a href="changeimage.php?tid=<?php echo $row->ID;?>"> &nbsp; Cập nhật ảnh</a>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Địa chỉ</label><textarea type="text" name="address" id="address" class="form-control" rows="3" cols="12" required="true"><?php  echo $row->Address;?></textarea></div>
</div>
</div>
