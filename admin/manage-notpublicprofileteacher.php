...
$query->execute();
echo '<script>alert("Hồ sơ đã bị xóa")</script>';
...
<head>
    ...
    <title>HTQLGHSGV || Quản lý hồ sơ Bí mật</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Quản lý giáo viên</a></li>
                            <li class="active">Quản lý hồ sơ Riêng tư</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Quản lý hồ sơ Riêng tư</strong>
                            </div>
                            <div class="card-body">
